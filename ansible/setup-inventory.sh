...
echo ""
echo "📡 Getting IPs from Terraform..."
...
if [ -z "$ZEPPELIN_IP" ] || [ -z "$SPARK_IP" ] || [ -z "$NEO4J_IP" ]; then
    echo "❌ Error: Could not get IPs from Terraform."
    echo "   Make sure you have run 'terraform apply' first."
    exit 1
fi

echo "  ✅ Zeppelin: $ZEPPELIN_IP"
echo "  ✅ Spark: $SPARK_IP"
echo "  ✅ Neo4j: $NEO4J_IP"
